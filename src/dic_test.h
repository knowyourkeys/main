...
string found_in_dic(const string &pass)
{
...
bool close_to_dic(const string &pass){
...
bool isspecial(const string &pass){
...
string how_strong(const string &pass,const bool &special)
{
